...
To release, merge the release-please PR and require both the `release-please` workflow's Linux and macOS jobs to pass. The release remains a draft until the signed artifact passes verification and runtime E2E, receives a valid checksum, and uploads successfully. Do not upload a replacement DMG or Linux package, and do not update the tap, by hand.
