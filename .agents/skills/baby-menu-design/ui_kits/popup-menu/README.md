...
5. **Use the header controls** in the live app to install an available update, open settings, or fully quit Baby Menu.
...
| --- | --- | --- |
| `App.tsx` | `App.jsx` | The mode toggle is gone; the live app has update, settings, and quit controls in the header, and the composer is hidden while settings are open. |
